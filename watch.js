...
function processFile(filePath) {
    fs.readFile(filePath, (err, data) => {
		...
		if (match2) {
		    ...
		    // 調用插入函數
		    insertPrescription(pid, presec, predate, results, pretype,prem,preday,precount).catch(console.error);
		    socket.emit('refreshData', { pid, name,pretype,results,prem,preday,precount });
...
async function insertPrescription(pid, presec , predate, drugs ,pretype,prem,preday,precount) {
